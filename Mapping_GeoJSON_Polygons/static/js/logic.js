...
let torontoHoods = "https://raw.githubusercontent.com/britnijgrimm/Mapping_Earthquakes/main/torontoNeighborhoods.json"
...
L.geoJson(data, { 
  ...
  onEachFeature: function(feature, layer) {
    layer.bindPopup("Neighborhood: " + feature.properties.AREA_NAME + "</h3>");
}
})
.addTo(map)
});
